class PostersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @poster.save
        format.html { redirect_to @poster, alert: 'Poster was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @poster.update(poster_params)
        format.html { redirect_to @poster, alert: 'Poster was successfully updated.' }
  ...
  def destroy
    @poster.destroy
    respond_to do |format|
      format.html { redirect_to posters_url, alert: 'Poster was successfully destroyed.' }
      format.json { head :no_content }
    end
  end

  def get_data
   # JSON.parse Poster.all.to_json
